...
var lt1 = require( './element.js' ),
	lt2 = require( './array.js' ),
	lt3 = require( './accessor.js' ),
	lt4 = require( './matrix.js' ),
	lt5 = require( './typedarray.js' );
...
function lt( x, y, options ) {
	...
	if ( isNumber( x ) || isString( x ) ) {
		if ( options ) {
			throw new Error( 'lt()::options object is only applicable when first argument is array- or matrix-like. Value: `' + options + '`.' );
		}
		if ( isMatrixLike( y ) ) {
